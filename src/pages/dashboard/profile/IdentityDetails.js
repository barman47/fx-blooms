                    ...
                    <form onSubmit={onSubmit} noValidate>
                        <Grid container direction="row" spacing={3}>
                            <Grid item xs={12}>
                                ...
                                <Typography variant="subtitle1" component="p" style={{ fontWeight: 500 }} className={classes.label}>{documentType}</Typography>
                                {/* <FormControl 
                                    variant="outlined" 
                            ...
                            {/* <Grid item xs={12} md={6}>
                                ...
                                <Typography variant="subtitle1" component="p" className={classes.label}>{idNumber}</Typography>
                                <TextField 
                            ...
                            <Grid item xs={12} md={6}>
                                ...
                                {idFront && <img src={idFront} alt="ID Front" className={classes.photograph} onMouseEnter={() => handleModalOpen(idFront, 'ID Front')} />}
                                {/* <TextField 
                                    className={classes.info}
                                    value={LastName}
                            ...
                            <Grid item xs={12} md={6}>
                                ...
                                {idBack && <img src={idBack} alt="ID Back" className={classes.photograph} onMouseEnter={() => handleModalOpen(idBack, 'ID Back')} />}
                                {/* <TextField 
                                    className={classes.info}
                                    value={Email}
                            ...
                            <Grid item xs={12} md={6}>
                                ...
                                {img && <img src={img} alt="Photograph" className={classes.photograph} onMouseEnter={() => handleModalOpen(img, 'Photograph')} />}
