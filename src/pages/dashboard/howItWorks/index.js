    ...
    return (
        <Box component="section" className={classes.root}>
            ...
            <Accordion className={classes.accordion} expanded={expanded === 'panel4'} onChange={handleChange('panel4')}>
                <AccordionSummary className={classes.accordionHeader}>
                    <ViewListOutline className={classes.icon} />
                    <Typography variant="h6" className={classes.heading}>How to exchange NAIRA for EUR on FXBLOOMS</Typography>
                </AccordionSummary>
                <AccordionDetails className={classes.content}>
                    <Typography variant="body2" component="p" className={classes.text}>A user can exchange NAIRA for EURO by accepting an offer (BUY EUR) or creating a new offer- SELL NGN.</Typography>
            ...
            <Accordion className={classes.accordion} expanded={expanded === 'panel5'} onChange={handleChange('panel5')}>
                <AccordionSummary className={classes.accordionHeader}>
                    <ViewListOutline className={classes.icon} />
                    <Typography variant="h6" className={classes.heading}>How to exchange EURO for NAIRA  on FXBLOOMS</Typography>
                </AccordionSummary>
                <AccordionDetails className={classes.content}>
                    <Typography variant="body2" component="p" className={classes.text}>A user can exchange EURO for NAIRA  by accepting an offer -BUY NGN or creating a new offer- SELL EUR. </Typography>
