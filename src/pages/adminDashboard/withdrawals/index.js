...
const Withdrawals = () => {
  ...
  return (
    <>
      ...
      />
      <section
        className={clsx(classes.root, "animate__animated animate__fadeInLeft")}
      >
          ...
          >
            ...
            {openXport ? (
              <Box className={classes.exportBox} component="span">
                <Typography onClick={downloadAll} component="span">
                  Export All
                </Typography>
                <Typography onClick={downloadRecords} component="span">
                  Export Page
                </Typography>
              </Box>
            ) : (
            ...
            <Box component="div" className={classes.filterBoxContainer}>
              <Box component="div" className={classes.filterBoxContent}>
                ...
                <Box component="div" className={classes.filterBoxMain}>
                  ...
                  <Box
                    component="div"
                    className={classes.filterTransactionType}
                  >
                  ...
                  <Box component="div" className={classes.filterButton}>
                    <GenericButton
                      clickAction={() => setOpenFilterBx(false)}
                      bdaColor="#1E6262"
                      bxShadw="none"
                      fontColor="#1E6262"
                      buttonName="Cancel"
        ...
        {withdrawalScreen ? (
          <Box component="div" className={clsx(classes.withdrawalScreen)}>
            <Box
              component="div"
              className={clsx(
              ...
              {screen ? (
                <>
                  <Box component="div" className={classes.formGrp}>
                    ...
                    >
                      ...
                      >
                        {account.result &&
                          account.result.map((acct, i) => (
                            <MenuItem key={i} value={acct.bankName}>
                              {acct.bankName}
                            </MenuItem>
                          ))}
                      </Select>
                ...
                <>
                  {loadingReqs ? (
                    ...
                    >
                      <Typography variant="h6">No batch Requests</Typography>
                      <GenericButton
                        clickAction={() => closeWithdrawalScreen()}
                        buttonName="Exit"
                        fontColor="white"
                        fontsize="15px"
                        bxShadw="none"
                    ...
                    <Typography mt={30} align="center" component="span">
                      <CheckboxMarkedCircleOutline
                    ...
                    <>
                      ...
                      >
                        <Table aria-label="a dense table">
                          ...
                          <TableBody>
                            {withdrawalRequests &&
                              withdrawalRequests.map((wallet, i) => (
                                <TableRow
                                  sx={{
