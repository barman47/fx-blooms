...
import {
    olimpicMedals as data,
    energyConsumption as data2,
...
const useStyles = makeStyles((theme) => ({
    ...
    recentDivider: {
        ...
        padding: ".72px",
        width: "1px",
        margin: theme.spacing(0, 0, 0.3, 2.125),
    },
...
const Label = (props) => (
    <Legend.Label
        {...props}
        className={useStyles().chartLegend}
        sx={{ whiteSpace: "nowrap", fontSize: "3px !important" }}
    />
);
...
const Home = ({
    ...
    const [loadingTransactionVolume, setLoadingTransactionVolume] =
        useState(false);
    ...
    useEffect(() => {
        if (totalCustomersWithNoProfile && totalCustomers) {
            const noProfilePercentage = Math.round(
                (totalCustomersWithNoProfile / totalCustomers) * 100
            );
    ...
    const handleSwitchCase = useCallback(
        (switchType, getFunction, setLoadingType, setFilterType, total) => {
    ...
    const handleListingsFilter = useCallback(
        (timeframe) => {
            handleSwitchCase(
                timeframe,
                getListingCount,
                setLoadingListingCount,
                setListings,
                totalListings
            );
        },
    ...
    const handleVolumeFilter = useCallback(
        (timeframe) => {
            console.log("eur", totalEuroTransfered);
            handleSwitchCase(
                timeframe,
                getTransactionVolume,
                setLoadingTransactionVolume,
                setVolume,
                totalEuroTransfered
            );
        },
    ...
    const handleActiveUserFilter = useCallback(
        (timeframe) => {
            handleSwitchCase(
                timeframe,
                getTransactionVolume,
            ...
            >
                ...
                <Grid item xs={12} className={classes.stats}>
                    <Box component="div" className={classes.userGraph}>
                        ...
                        <Chart data={data2} className={classes.chart}>
                ...
                <Grid item xs={12} className={classes.stats}>
                    ...
                    >
                        ...
                        <Box component="div" className={classes.supportTable}>
                            ...
                            >
                                <Typography
                                    className={classes.supportHeader}
                                    component="span"
                                    variant="h6"
                                >
                                    Total Tickets
                ...
                <Grid item xs={12} className={classes.stats}>
                    ...
                    >
                        ...
                        <Box
                            component="div"
                            className={classes.userActivitiesHeader}
                        >
                        ...
                        <UserActivitiesRow
                            classname={classes.userActivitiesBody}
                            category={"No Profile"}
                            number={totalCustomersWithNoProfile ?? 0}
                            progressNumber={totalNoProfilePercent ?? 0}
                        />
                        <UserActivitiesRow
                            classname={classes.userActivitiesBody}
                            category={"Not signed in in the last 30days"}
                            number={323}
                            progressNumber={10}
                        />
                        <UserActivitiesRow
                            classname={classes.userActivitiesBody}
                            category={"Have transact in the last 30days"}
                            number={200}
                            progressNumber={100}
                        />
                        <UserActivitiesRow
                            classname={classes.userActivitiesBody}
                            category={"No listing in the last 30days"}
                            number={650}
                            progressNumber={100}
                        />
                    </Box>
                    <Box component="div" className={classes.transactionSection}>
                        ...
                        >
                            ...
                            <Box
                                component="div"
                                className={classes.recentTransactionList}
                            >
                                <RecentTransactions
                                    classes={classes}
                                    recentName={"Listing"}
                                    recentDate={"22 DEC, 2021 7:00PM"}
                                    recentAmount={3000}
                                >
                                    <CompareHorizontal
                        ...
                        >
                            ...
                            <Box component="div" className={classes.amlContent}>
                                <AmlBoard
                                    classes={classes}
                                    amlTitle={"Transaction withhold"}
                                    amlNumber={24}
                                />
                                <AmlBoard
                                    classes={classes}
                                    amlTitle={"Unassigned risk profile"}
                                    amlNumber={30}
                                />
                                <AmlBoard
                                    classes={classes}
                                    amlTitle={"Suspended accounts"}
                                    amlNumber={12}
                                />
                                <AmlBoard
                                    classes={classes}
                                    amlTitle={"Pending cases"}
                                    amlNumber={28}
                                />
                                <AmlBoard
                                    classes={classes}
