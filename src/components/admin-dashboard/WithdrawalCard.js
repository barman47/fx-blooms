...
const WithdrawalCard = ({ cardTitle, totalAmount }) => {
    ...
    return (
        <Box component="div" className={classes.withdrawalCard}>
            <Typography variant="h6" className={classes.withdrawalCardTitle}>
                {cardTitle}
            </Typography>
            <Typography
                component="span"
            ...
            >
                <GenericSelect
                    ...
                    selectValue={withdrawalFilter}
                    setOnChange={setDepositFilter}
                    loading={loadingDeposit}
                />
            </Typography>

            <Typography variant="h6" className={classes.withdrawalCardAmount}>
                {modifyAmount(totalAmount ?? 1)}
            </Typography>
