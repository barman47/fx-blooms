          ...
          >
            ...
            >
              <FormControlLabel
                ...
                control={
                  <Checkbox
                    name="checked"
                    onChange={(e) => handleCheckBox(e, customer)}
                    checked={customer.paymentStatus === 2 ? false : check[i]}
            ...
            <Typography
              ...
              className={clsx(
                ...
                classes.status,
                handleStatusStyle(
                  handlePaymentStatus(customer.paymentStatus, "S"),
                  classes
                )
              )}
              variant="subtitle1"
            ...
            <Typography
              component="span"
              className={clsx(classes.tableCell, displayChck && classes.noShow)}
              variant="subtitle1"
            >
              <IconButton
                variant="text"
